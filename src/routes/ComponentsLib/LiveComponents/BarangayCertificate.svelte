<script>
    ...
    import {cordionLogic, onSnapsBgyCert, showCertEditLogic, showCertAddModal, compareCertValue } from "../BoundComponents/clickOutside";
    ...
    <div class="min-h-[50vh] p-10">
        <div class=" flex gap-2 items-center mb-2">
            <div class="w-full flex gap-2">
                ...
                <div class="">
                    <Button TITLE="Generate Barangay Certificate" on:click={() => showPrintModel.set(true)}/>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-2 bg-white p-4 max-w-fit mx-auto rounded-lg mt-2 absolute left-0 right-0 border-2 border-guiColor z-10">
            <p class="text-xl text-center font-bold p-2 text-slate-500">New Barangay Certificate</p>
            <div class="">
            ...
            <div class="flex gap-2">
                ...
                <Button TITLE="Cancel" on:click={()=>{showCertAddModal.set(false)}}/>
            </div>
        </div>
        {/if}
                    ...
                    <div class="">
                        <div class="flex flex-col gap-2 bg-guiColor p-4 max-w-fit mx-auto rounded-lg mt-2 absolute left-0 right-0 border-2 border-slate-200 z-10">
                            ...
                            <div class="flex gap-2">
                                ...
                                <Button TITLE="Cancel" on:click={() => {compareCertValue.set("")}}/>
                            </div>
                        </div>
                    </div>
                {/if}
