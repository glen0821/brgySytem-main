<script>
    ...
    export let bDate = "Complete birthdate";
    export let lengthOfStay = "Length of stay";
...
{#if showData}
    <div class="bg-slate-300 rounded-lg m-2" in:slide>
        <div class="p-4">
            ...
            <p class="font-bold">Length of stay:</p>
            <p class="p-2">{lengthOfStay}</p>

            <p class="font-bold">Purpose:</p>
            <p class="p-2">{purpose}</p>
        </div>
